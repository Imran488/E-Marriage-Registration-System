...
<head>
    ...
    <link href="{{url('website/css/font.css')}}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{url('website/css/simple-line-icons.min.css')}}">
    ...
    <link rel="stylesheet" href="{{url('website/css/magnific-popup.min.css')}}">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="{{url('website/css/theme.css')}}">
    <link rel="stylesheet" href="{{url('website/css/theme-elements.css')}}">
    <link rel="stylesheet" href="{{url('website/css/theme-blog.css')}}">
    <link rel="stylesheet" href="{{url('website/css/theme-shop.css')}}">

    <!-- Current Page CSS -->
    <link rel="stylesheet" href="{{url('website/css/settings.css')}}">
    <link rel="stylesheet" href="{{url('website/css/layers.css')}}">
    <link rel="stylesheet" href="{{url('website/css/navigation.css')}}">
    <link rel="stylesheet" href="{{url('website/css/component.css')}}">

    <!-- Skin CSS -->
    <link rel="stylesheet" href="{{url('website/css/default.css')}}">
    ...
    <!-- Head Libs -->
    <script src="{{url('website/js/modernizr.min.js')}}"></script>
    <style>
        .kalpurush {
    ...
    <link href="{{url('website/css/LandingPage.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{url('website/js/jquery.appear.min.js')}}"></script>
    <script src="{{url('website/js/jquery.easing.min.js')}}"></script>
    <script src="{{url('website/js/jquery.cookie.min.js')}}"></script>
    <script src="{{url('website/js/popper.min.js')}}"></script>
    <script src="{{url('website/js/bootstrap.min.js')}}"></script>
    <script src="{{url('website/js/common.min.js')}}"></script>
    <script src="{{url('website/js/jquery.validate.min.js')}}"></script>
    <script src="{{url('website/js/jquery.easypiechart.min.js')}}"></script>
    <script src="{{url('website/js/jquery.gmap.min.js')}}"></script>
    <script src="{{url('website/js/jquery.lazyload.min.js')}}"></script>
    ...
    <script src="{{url('website/js/jquery.vide.min.js')}}"></script>
    <script src="{{url('website/js/vivus.min.js')}}"></script>

    <!-- Theme Base, Components and Settings -->
    <script src="{{url('website/js/theme.js')}}"></script>

    <!-- Current Page Vendor and Views -->
    <script src="{{url('website/js/jquery.themepunch.tools.min.js')}}"></script>
    <script src="{{url('website/js/jquery.themepunch.revolution.min.js')}}"></script>
    <script src="{{url('website/js/jquery.flipshow.min.js')}}"></script>
    <script src="{{url('website/js/view.home.js')}}"></script>
