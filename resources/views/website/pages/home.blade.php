    ...
    <div class="owl-carousel owl-theme full-width owl-loaded owl-drag owl-carousel-init m-0" data-plugin-options="{'items': 1, 'loop': true, 'nav': true, 'dots': false,'autoplayHoverPause':false,  'autoplay':true, 'autoplayTimeout': 5000}">
      ...
      <div class="row pb-5 pt-5">
        <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="card-body">
            ...
            <p style=" color:black" class="card-text">"Our family is grateful to have the support from E-Marriage Registration System. We have trusted their work ethics to build our relationships between families."</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-12 col-sm-12">
        ...
        <div class="card-body">
          ...
          <p style=" color:black" class="card-text">"E-Marriage Registration System has really helped me and my family to find the right life partner. Their dedication and effort is remarkable."</p>
        </div>
      </div>
    </div>
  </div>
